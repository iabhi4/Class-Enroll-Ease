...
foreman start --formation "enroll=3, users_primary=1, users_secondary_1=1, users_secondary_2=1, krakend=1, dynamodb_local=1, notification_service=1, aiosmtpd=1, email_consumer=1, webhook_consumer=1"
